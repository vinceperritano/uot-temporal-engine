    ...
    with get_db() as conn:
        ...
        try:
            ...
            if worlds:
                ...
                # Phase 10: cross-run representative variance diagnostic.
                # Build current_slot_events from primary branch group events.
                try:
                    _curr_slot_evs = {}
                    ...
                    if _curr_slot_evs:
                        # Pass slot_source_coherence from the pq_at_seed if available,
                        # otherwise pass empty dict (diagnostic will use "moderate" default)
                        _sc_map = {}
                        try:
                            _pq_for_coh = getattr(_eng_ref, '_LAST_PRIMARY_QUESTION', {})
                        ...
                        _compute_cross_run_representative_variance(
                            conn, series_id, run_id, _curr_slot_evs, _sc_map)
