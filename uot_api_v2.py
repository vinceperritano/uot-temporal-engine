    ...
    try:
        ...
        with get_db() as conn:
            ...
            try:
                ...
                # Get slot labels from canonical_slots in _pq_at_seed (CanonicalOutcomeSlot
                # objects or dicts, whichever the engine stored).
                _cs_list = _pq_at_seed.get("canonical_slots") or []
                for _cs in _cs_list:
                    try:
