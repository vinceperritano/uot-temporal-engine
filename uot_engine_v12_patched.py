...
_ENGINE_DEPLOY_TAG = "phase-9.10-weighted-coherence"
...
NATURAL EVIDENCE EXTRACTION (Phase 8.10 / Phase 9.9 revision):
Your job is to describe what sources POSITIVELY CLAIM — what IS happening, what IS being
forecast, what IS the current state — and score the probability of that claim being true.
You are never responsible for constructing negations of canonical slot labels, inverting
probabilities, or determining how evidence relates to any slot. That is Stage C's job.

ALWAYS extract evidence as a positive claim about what exists, is happening, or is forecast:
  ...
  NOT:     "Trilateral AI Regulatory Harmonization Will Not Occur Within Horizon" — p=0.04
  ...
  NOT:     "Large Fed rate cuts will not occur" — p=0.10
  ...
  NOT:     "Testing moratorium will not be announced" — p=0.12

TRUE negative/status-quo outcomes are NORMAL and remain allowed — these describe
what IS actually happening, not a constructed negation of a slot label:
  "Article 5 remains uninvoked"       ← fine: this IS the claimed state
  "No formal ceasefire is in place"   ← fine: this IS the natural claim
  "Status quo of fragmentation holds" ← fine: this IS what sources describe

DISTINCTION: A source saying "no ceasefire has occurred" is describing a real-world state
you can extract naturally. A source saying "China will not invade Taiwan" should become
"China-Taiwan military standoff persists with deterrence holding" — not a label that
mirrors the canonical slot wording with a negation added.

NEVER invent a label that contains BOTH the core wording of a canonical slot label AND a
negation word ("will not," "does not," "fails to," "no," "ruled out"). If you find yourself
about to do this: rewrite to describe what the source actually claims in its own terms.
Stage C will determine how your natural event relates to the canonical slots.

For disconfirming evidence, extract the POSITIVE claim the source is actually making:
  ...
  "Strong institutional consensus favors continued oil demand growth through 2030"
