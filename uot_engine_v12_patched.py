...
_ENGINE_DEPLOY_TAG = "phase-10.3-partition-diagnostic"
...
def web_search_sources(topic: str, observer_basis: Optional[dict] = None, follow_up_queries: Optional[List[str]] = None, canonical_slots=None, horizon=None, anchor_families: Optional[List[str]] = None) -> List[SourcePacket]:
    ...
    # Documents why same-scenario runs can produce 16 vs 45 packets — query
    # generation is stable but live search returns variable result counts.
    _qp_counts = {}
    ...
    # Reset per-run stats before compression pass
