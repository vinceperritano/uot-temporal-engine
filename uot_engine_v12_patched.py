...
def extract_near_discrepancies(discrepancies: list) -> list:
    """
    Return discrepancies with severity 0.03–0.05 as near-miss signals.
    These did not cross the detection threshold but indicate field tension.
    Per GPT Phase 3: record these to diagnose whether thresholds are too high.
    """
    return [d for d in discrepancies if 0.03 <= d.severity < 0.05]
