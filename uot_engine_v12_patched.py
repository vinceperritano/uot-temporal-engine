...
Identify 10–15 candidate events for a Unified Observer Theory timeline graph from the topic and sources. The source set has been expanded with outcome-targeted searches for every canonical slot — use this to find events for quieter outcomes, not just the dominant narrative. Include low-probability events (p=0.05–0.20) for canonical slots with weak evidence.
...
Aim for 10-15 events. Do not stop at 8. Every canonical slot should have at least one associated event if any evidence exists, even at low probability.
