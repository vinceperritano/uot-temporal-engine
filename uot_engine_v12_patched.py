...
For threshold questions, output slot metadata fields:
  threshold_unit (e.g. "basis_points", "percentage_points"),
...
Slot description guidance: write descriptions naming the scenario's primary actors and concrete evidence patterns rather than abstract phrases. For a North Korea scenario, write "North Korea escalates through ICBM tests or nuclear demonstrations" rather than "escalation occurs." This helps the engine match evidence to slots.
...
{{
  ...
  "canonical_slots": [
    {{
      ...
      "threshold_unit": "(optional, threshold_bucket only: e.g. \"basis_points\")",
      "lower_bound": "(optional, threshold_bucket only: numeric)",
      "upper_bound": "(optional, threshold_bucket only: numeric)",
      "aliases": ["(optional, threshold_bucket only: natural-language phrases, e.g. \"one cut\", \"25 bps\")"],
      "actor_scope": "(optional: primary actor(s), e.g. \"North Korea\", \"US-EU-China\")",
      "geographic_scope": "(optional: domestic_us | international | regional | global | bilateral)",
      "scale_level": "(optional: subnational | national | bilateral | multilateral | global)",
      "directionality": "(optional: continuation | intensification | reversal | breakthrough | decline | uncertain)",
      "action_exemplars": ["(optional: 2-3 evidence patterns that would support this slot)"],
      "negative_examples": ["(optional: 1-2 patterns that would NOT support this slot)"]
    }}
  ]
}}
""".strip()
