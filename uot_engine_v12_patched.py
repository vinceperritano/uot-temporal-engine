...
def apply_structure_to_event_candidates(
    ...
    """
    Phase 5: Apply Stage C structure (primary slot-based branch group + secondary groups + causal edges).
    Creates legitimate synthetic events for required canonical slots with no organic match.
    """
    ...
    # ── PRIMARY BRANCH GROUP — map canonical slots to organic or synthetic events ─
...
def collect_and_extract_seeded_events(topic: str, observer_basis: dict,
    ...
    # Stage Q: Primary Question Decomposition (Phase 5)
    ...
    event_dicts, stage_c_edges = apply_structure_to_event_candidates(event_dicts, structure, _pq)
