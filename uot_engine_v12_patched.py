...
def web_search_sources(topic: str, observer_basis: Optional[dict] = None, follow_up_queries: Optional[List[str]] = None, canonical_slots=None, horizon=None) -> List[SourcePacket]:
    """
...
def collect_and_extract_seeded_events(topic: str, observer_basis: dict,
                                       ...
                                       prior_slot_probs: dict = None) -> tuple:
    """
