...
_ENGINE_DEPLOY_TAG = "phase-9.11-semantic-bridge"
...
Status-quo and absence-of-change claims are completely normal events:
  ...
  "Regional frameworks remain fragmented"

Score every event's probability as: how likely is it that THIS claim is true?
A source saying "strong institutional consensus holds" \u2192 high probability (0.80-0.90) if
the source is confident. A hedged forecast \u2192 lower probability (0.40-0.60).
