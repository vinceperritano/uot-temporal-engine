...
_ENGINE_DEPLOY_TAG = "phase-9.7-source-attribution"
...
natural event you extract. Your only job is to describe what the source actually says and assign
probability to THAT natural claim — the same way you handle every other event.
