...
{{
  ...
  "canonical_slots": [
    {{
      "slot_id": "short_snake_case_id",
      "label": "Human-readable outcome label",
      "description": "One sentence describing what this outcome looks like, naming the primary actors.",
      ...
      "lower_bound": 25,
      "upper_bound": 100,
      "aliases": ["one cut", "25 bps", "modest easing"],
...
Fields threshold_unit, lower_bound, upper_bound, and aliases are only for threshold_bucket slots.
Fields actor_scope, geographic_scope, scale_level, directionality, action_exemplars, and negative_examples are optional enrichment — include them when you can, omit when uncertain.
""".strip()
