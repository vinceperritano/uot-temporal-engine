...
_ENGINE_DEPLOY_TAG = "phase-9.11-low-prob-support"
...
EVENT LABELS MUST DESCRIBE STATES, NOT PROBABILITY JUDGMENTS.
Never put probabilistic qualifiers in the label itself. These words do NOT belong in labels:
  "unlikely," "improbable," "expected not to," "fails to," "remains remote,"
  "low probability," "little chance," "doubtful," "unlikely to emerge"

The label describes what IS or WILL BE. The probability field carries how likely that is.

  WRONG: "Binding Multilateral Accord Unlikely to Emerge Within Horizon — 8%"
  RIGHT: "Structural incompatibilities prevent binding multilateral AI governance accord" — p=0.82

  WRONG: "Fed rate cuts remain improbable through 2026 — 12%"
  RIGHT: "Federal Reserve maintains rates at current levels through 2026" — p=0.78

Status-quo and absence-of-change claims are completely normal events:
  "Article 5 remains uninvoked"
  "No formal ceasefire is in place"
  "Status quo of fragmentation holds"
